            ...
            loadDownFn: function (me) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (arrLen > 0) {
                            for (var i = 0; i < arrLen; i++) {
                                ...
                                result += '<div class="well-xs well media"><div class="media-left"><a href="/article/' 
                                                ...
                                                + item.CreatedAt + '</li><li><strong><span class="ion-clock" title="发布时间 publiced time" data-time="2017-05-12 07:21:55"></span></strong>'
                                                + item.CreatedAt + '</li><li><strong><span class="glyphicon glyphicon-eye-open" title="阅读数量 read count"></span></strong>'
                        ...
                        //插入dom
                        $('section.content > div.well:last').append(result);
                        // 每次数据插入，必须重置
                        me.resetload();
                    },
